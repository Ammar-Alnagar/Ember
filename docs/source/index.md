...
Ember (Ember) is a toolkit for deploying and serving Large Language Models (LLMs). Ember enables high-performance text generation for the most popular open-source LLMs, including Llama, Falcon, StarCoder, BLOOM, GPT-NeoX, and T5.

![Ember](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/Ember.png)

Ember implements many optimizations and features, such as:
...
Ember is used in production by multiple projects, such as:
